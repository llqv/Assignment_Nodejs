...
const DetailProduct = {
    render: async () => {
        ...
        <section class="flex justify-items-start">
            <div class="">
                <img src="https://cdn2.cellphones.com.vn/358x/media/catalog/product/a/7/a73-xanh.jpg"
                    class="rounded-md flex-initial w-max " alt="">
                <div class="flex">
                    <a href="" class="inline-black w-12 h-12 rounded-md text-white border-2 border-red-600">.</a>
        ...
        <section class="recent-posts py-10">
            <div class="rounded-md">
                <input  onclick="">
            </div>


            <a href="" class="inline-black bg-red-600 py-5 px-10 rounded-md text-white">Mua Ngay</a>
        </section>
        <section class="w-[232px] h-[307px] mx-1 rounded-lg object-cover border-2 border-stone-400">
            <img src="https://cdn2.cellphones.com.vn/358x/media/catalog/product/b/u/buds-live_1.jpg" alt=""
                class="w-[160px] h-[160px mx-auto] ">
            <div>
        ...
        <section class="bg-stone-300 max-w-6xl max-h-40	 ">
            ...
            <div>
                <p>Thưởng thức không gian giải trí cực đỉnh - Màn hình lớn 6.7 inch, độ phân giải Full HD+, 120Hz mượt
                    mà</p>
            </div>
            <div>
        ...
        <div class="mt-4">
            <p>Năm 2022 hứa hẹn sẽ là một năm rất đáng trông đợi đối với những ai là fan của thương hiệu điện thoại
                ...
                hình, trong đó phải kể đến chiếc Samsung Galaxy A73 với nhiều cải tiến so với thế hệ trước. Vậy sản phẩm
        ...
        <div class="mt-3">
            <p>Điện thoại cao cấp nhất dòng Galaxy A series sở hữu nhiều nâng cấp đáng giá so với thế hệ trước, từ ngoại
        ...
        <div class="mt-3">
            <p>Trước khi mua bất kỳ chiếc điện thoại nào, người dùng cũng sẽ quan tâm đến thiết kế sản phẩm trước. Với
                phiên bản A73, Samsung đã tạo nên một chiếc smartphone với vẻ ngoài mang đến cảm giác sang trọng và tinh
                tế.</p>
        </div>
        <div class="mt-3">
            Samsung Galaxy A73 được thiết kế gọn nhẹ với tiêu chí đáp ứng khả năng mang theo để tiện đi lại cho người
