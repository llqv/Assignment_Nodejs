import { listCategory, RemoveCate } from "../../api/category";
    ...
    render: async () => {
        ...
        <div class="flex mt-3">
            ...
            <div>
                ...
                <a data-navigo href="/adminPages/addcate" class="mr-5 border-blue-500 text-blue-500 border-4 rounded-md p-1"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <table class="table-auto w-11/12 mx-auto my-5 text-center">
                    <thead>
                        ...
                        <th class="text-center p-3 px-5">Tên danh mục</th>
                        <th class="text-center p-3 px-5">Thao tác</th>
                        </tr>
                    </thead>
                    <tbody>
                    ${rescate.map((item: Products, index: number) => `
                    ...
                    <td class="">
                            ...
                            <a data-navigo href="/admin/categories/edit/${item._id}"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    afterRender: () => {
        ...
        for (let btn of btns) {
            ...
            btn?.addEventListener('click', async function () {
                console.log(id);
                const action = await RemoveCate(id)
                if (action) {
                    alert("Xóa danh mục thành công !")
                    // location.reload()
                    rerender("#app", ListCategory)
                }
            })
        }
