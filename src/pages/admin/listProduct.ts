                ...
                <table class="w-full mt-10 text-md rounded mb-4">
                    ...
                    <tbody>
                        <tr class="border-t-2 hover:bg-orange-100">
                            <td class="text-center p-3 px-5">1</td>
                            <td class="text-center p-3 px-5">product</td>
                            <td class="w-[120px] p-3 px-5"><img class="w-20 h-20 rounded-full" src="https://picsum.photos/400/400" alt=""></td>
                            <td class="text-center p-3 px-5">50000</td>
                            <td class="text-center p-3 px-5">Mô tả</td>
