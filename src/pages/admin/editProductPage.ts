    ...
    <div class="mx-10">
        ...
        <div id="formAdd" action="">
          <div class="grid grid-cols-3 gap-8 ">
              ...
              <br>
              <div class="mt-5">
                <textarea id="shortDesc" class="w-full rounded-b-lg drop-shadow-md p-3" placeholder="Mô tả ngắn:" cols="30" rows="10">${data.shortDescription}</textarea>
            ...
            <div class="col-span-2 text-gray-700">
              ...
              <div class="mt-5">
                ...
                <br>
                <input id="name" class="w-full mr-10 rounded-md h-8 my-4 p-3" type="text" value="${data.name}">
              ...
              <div class="flex">
                <div class="mt-5 w-1/2 mr-1">
                  ...
                  <br>
                  <input id="price" class="w-full mr-10 rounded-md h-8 my-4 p-3" type="number" value="${data.originalPrice}">
                <div class="text-red-500" id="erPrice"></div>
                </div>
                <div class="mt-5 w-1/2 ml-1">
                  <label for="">Giá khuyến mãi</label>
                  <br>
                  <input id="sale" class="w-full mr-10 rounded-md h-8 my-4 p-3"  type="number" value="${data.saleOffPrice}">
